...
| Property | Details
| --- | ---
| anchor | Type:`String`<br>If property is present, must be one of the following values: <ul><li>`center`</li><li>`left`</li><li>`right`</li><li>`top`</li><li>`bottom`</li><li>`topLeft`</li><li>`topRight`</li><li>`bottomLeft`</li><li>`bottomRight`</li></ul>
| enable | Type:`Boolean`
