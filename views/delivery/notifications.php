...
<body>
	<div class="container">
		...
		<div class="nine columns" id="homecontent">
			...
			<?php foreach($this->notification_data as $notification):?>

				<div class="row message_row">
					<div class="one column profilePicture"> 
						<img  src="<?= $notification['notification_image']?>" class="profileImage" style="">
					</div>
					<div class="eleven columns message" >
						<div class="row">
							<label  style="font-size: 20px; color: maroon;"><?= $notification['notification_title']?></label>
						</div>
						<div class="row">
							<p style="font-size: 17px;"><?= $notification['notification_content']?></p>
						</div>
