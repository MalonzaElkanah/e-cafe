...
<div class="row">
	...
	<div class="row" id="chatMessages" >
		<?php 
			...
			$senderID = "";
			$customer = false;
			if($chat['sender_status']=="RESTAURANT"){
				$senderName = $chat['restaurant_name'];
				$senderPic = $chat['r_profile_picture'];
				$senderID = $chat['r_message_index'];
			...
			}else if($chat['sender_status']=="CUSTOMER"){
				$customer = true;
			}
			$i++;
		?>
